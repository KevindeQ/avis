#include "avis/graphics/root_signature.h"
...
namespace graphics
{
    ...
    root_signature root_signature_builder::build(render_device& device)
    {
        ...
        throw_if_failed(device.device_ptr()->CreateRootSignature(
