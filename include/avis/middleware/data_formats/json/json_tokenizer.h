#ifndef MIDDLEWARE_DATA_FORMATS_JSON_JSON_TOKENIZER_H
#define MIDDLEWARE_DATA_FORMATS_JSON_JSON_TOKENIZER_H
...
namespace data_formats::json
{
    ...
    private:
        ...
        std::size_t get_current_offset() const
        {
            return untokenized_source_.data() - source_.data();
        }
