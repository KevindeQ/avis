#ifndef RENDER_GRAPH_RENDER_PIPELINE_H
#define RENDER_GRAPH_RENDER_PIPELINE_H
...
namespace render_graph
{
        ...
        typename render_pass::graphics_exec_callback_type<render_pass_data> execute_pass)
    {
        ...
        // render_passes.emplace_back(render_pass_name, pass_data, execute_pass);
        ...
        typename render_pass::compute_exec_callback_type<render_pass_data> execute_pass)
    {
        ...
        // render_passes.emplace_back(render_pass_name, configure_pass, execute_pass);
